...
export const post: BlogPost = {
  meta: {
    ...
    readingMinutes: 4,
    cover: "/marketing/blog/engineer-presenting-portfolio-to-hiring-manager.webp",
    coverAlt: "A Kenyan software engineer presenting her project portfolio to a hiring manager",
  },
  Body,
};
