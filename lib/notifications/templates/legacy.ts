  ...
  return {
    ...
    html: renderEmail({
      ...
      section: {
        ...
        bodyHtml: `<p style="margin:0;">Three months ago you built something at <strong>${eventTitle}</strong>. Did it become a product?</p>
  ...
  return {
    ...
    html: renderEmail({
      ...
      section: {
        ...
        bodyHtml: `<p style="margin:0;">We did not hear back about your project from <strong>${eventTitle}</strong>, so it is now marked unresponsive on your portfolio. You can still update it anytime.</p>`,
        ctaUrl: url,
  ...
  return {
    ...
    html: renderEmail({
      ...
      section: {
        ...
        bodyHtml: `<p style="margin:0;">The final half of a prize for <strong>${eventTitle}</strong> is waiting on your milestone confirmation, now ${overdueDays} day${overdueDays === 1 ? "" : "s"} past due.</p>
