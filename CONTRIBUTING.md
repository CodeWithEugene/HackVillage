...
By contributing to HackVillage you agree that your contributions will be licensed under the [Apache License 2.0](./LICENSE.md) that covers this project. You retain copyright over your own contributions; by submitting a PR you grant the project a perpetual, irrevocable license to use, modify, and distribute your contribution under those terms.
