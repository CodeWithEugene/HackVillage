...
export const metadata: Metadata = {
  ...
  description:
    "How HackVillage locks 100% of every prize pool before a hackathon goes live, and how winners get paid.",
};
...
export default function HowEscrowWorksPage() {
  return (
    ...
    >
      ...
      <p>
        Every step is also recorded on a public blockchain (Polygon) by our PrizeVault contract. The
        contract doesn&apos;t hold money. It keeps a tamper-proof record of when a pool was locked
        and when each payout was made, so anyone can check the history against the payment
        provider&apos;s receipts.
      </p>
      ...
      <p>
        ...
        within 48 hours, and every decision is written to our audit log. Deposits stay closed until
        verification is approved, and verified organizers show a Verified Organizer badge on their
        hackathons.
      </p>
      ...
      <p>
        ...
        in one Paystack checkout. For example, a KES 500,000 pool is a KES 525,000 checkout. The fee
        is kept separate and never reduces the prizes.
      </p>
      <p>
      ...
      <p>
        As soon as Paystack confirms the payment and the deposit covers the full pool, three things
        happen together: the vault locks, the hackathon goes live, and the Prize Verified badge
        appears on its page. The blockchain record of the lock follows right after. Registered
        developers are notified that the prize is secured.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          prize is split between members. That split is part of the record, and the team settles it
          among themselves.
        </li>
      </ul>
      ...
      <p>
        ...
        winnings page after 14 days. The HackVillage team reviews it, and if the milestone was met,
        releases the final payout through the same path as every other payout. The money stays
        locked in escrow while the dispute is open.
      </p>
      ...
      <ul>
        <li>
          ...
          HackVillage team for manual review. The money stays in escrow until a payout is confirmed
          as paid.
        </li>
        <li>
          <strong>No double records:</strong> each half of each prize has exactly one payout record,
          so a retry resends that same payout instead of creating a new one.
        </li>
        <li>
          <strong>Nightly checks:</strong> every night we compare our records against the ledger and
          flag anything that doesn&apos;t match to the team.
        </li>
      </ul>
      ...
      <p>
        ...
        deposited, including the platform fee. Once a hackathon is live, its prize pool is committed
        to the developers taking part.
      </p>
      ...
      <p>
        Each organizer also carries a public trust score, which starts at 100. For example, missing
        the 48-hour standard for delivering hackathon photos costs 10 points. Read more in our{" "}
        <Link href="/privacy">Privacy Policy</Link>.
      </p>

      <h2>12. A Note On Our Pilot</h2>
      <p>
        HackVillage is in its pilot. Until our live payment keys and the audited blockchain contract
        are switched on, deposits, payouts and blockchain records run in test mode. Everything
        described on this page works the same way in test mode, without real money moving.
      </p>
